/* The frontend logic for the application */
...
app.client.request = (
  ...
  /* Add each querystring parameter to the path */
  let requestUrl = path + '?'
  let ampersand = false
...
/** @TODO refactor from here because the code is jacked */
